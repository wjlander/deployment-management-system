                  ...
                  <tr key={deployment.id} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        breakTime === 30 ? 'bg-green-100 text-green-800' :
                        breakTime === 15 ? 'bg-yellow-100 text-yellow-800' :
                      ...
                      <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        ...
                        <td className="px-4 py-3 text-sm">
                          <span className={`font-medium ${
                            parseFloat(variance) > 0 ? 'text-green-600' : 
                    ...
                    <>
                      ...
                      <div className="flex justify-between border-t border-blue-200 pt-2">
                        ...
                        <span className={`font-bold ${
                          totalActual > totalForecast ? 'text-green-600' : 'text-red-600'
                        }`}>
                          £{(totalActual - totalForecast).toFixed(2)}
                        </span>
                      </div>
                    </>
                  );
